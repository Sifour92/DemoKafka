...
public class KafkaConfig {
    ...
    public SenderOptions<String, Object> senderOptions() {
        ...
        props.put(
                ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, new TextXPath(this.settings, "//keySerializer")
                        .toString());
        props.put(
                ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, new TextXPath(this.settings, "//valueSerializer")
                        .toString());
